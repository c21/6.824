...
const (
	...
	MIN_ELECTION_TIMEOUT_MS = 150 // 2 * HEARTBEAT_TIMEOUT_MS 	// 150 //3 * HEARTBEAT_TIMEOUT_MS
	MAX_ELECTION_TIMEOUT_MS = 300 // * HEARTBEAT_TIMEOUT_MS		// 300 //5 * HEARTBEAT_TIMEOUT_MS
)
